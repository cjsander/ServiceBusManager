...
namespace Queue
{
    class ManagementConsole
    {
        ...
        private static string ServiceBusConnectionString = "Endpoint=sb://swordbase.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=CgoI3MBDs01WsvcV8ip25BaUxF0JSgY7JEmDGIliAaA=";
